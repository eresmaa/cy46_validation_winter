...
t[3] = v[3] ;
v[4] = ['FF','GX','TT','RH','NN','N75','CH','LC','PE3','PE12','VI']
t[4] = ['U10m','Max Wind Gust','T2m','Rh2m','Cloud cover','clouds <7500m','Cloud base','Low clouds','3h Precipitation','12h Precipitation','Visibility']
v[5] =[0]
v[5] =v[5].reverse()
t[5] =v[5]
